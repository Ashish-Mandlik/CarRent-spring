...
public class User {
	...
	public User(Long id, String firstName, String lastName, String email, String phoneNumber, String address,
			LocalDate dateOfBirth, String licenseNumber, String paymentInformation, String password) {
		super();
		this.id = id;
		this.firstName = firstName;
		this.lastName = lastName;
	...
	public String toString() {
		return "User [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", email=" + email
				...
				+ ", licenseNumber=" + licenseNumber + ", paymentInformation=" + paymentInformation + ", password="
				+ password + "]";
	}
